...
public class Field_Initialize {
	public static void main(String[] args) {
		...
		//1. 객체 생성 : 1. 생성자를 이용한 필드의 값 할당. 
		Fluit fluit1 = new Fluit("바나나", "노란색", 10); 
		fluit1.printAll();
		
		//2. 객체 생성 : 2. 필드의 직접 값할당
		Fluit fluit2 = new Fluit(); 
		fluit2.printAll();
		fluit2.fluitName = "딸기"; 
		fluit2.fluitColor="빨간색"; 
		fluit2.fluitCnt=20; 
		fluit2.printAll();

		//3. 객체 생성 : 3. setter 를 사용해 값을 할당
		Fluit fluit3 = new Fluit(); 
		fluit3.setFluitName("오랜지");
		fluit3.setFluitColor("주황색");
		fluit3.setFluitCnt(15);
